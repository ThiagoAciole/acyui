...
export const componentRoutes: ComponentRoute[] = [
  ...
  },
  {
    ...
    category: 'Feedback',
    icon: 'component',
    description: 'Provider raiz que configura tema e integra o sistema global de toast.',
    initialCode: block([
  ...
  },
  {
    ...
    initialCode: jsxSnippet(['Box', 'Text', 'Button', 'useToast'], [
      ...
      '    <Text color="subtle">',
      '      Este exemplo usa o sistema de toast configurado pelo ThemeProvider na raiz do playground.',
      '    </Text>',
      '    <ToastDemo />',
      '  </Box>',
      ');',
