...
export const componentRoutes: ComponentRoute[] = [
  ...
  },
  {
    ...
    initialCode: jsxSnippet(['Box', 'Text'], [
      ...
      '  >',
      '    <Text>',
      '      O playground principal usa o Sidebar como navegacao.',
      '    </Text>',
      '  </Box>',
      ');',
    ]),
  ...
  },
  {
    ...
    initialCode: jsxSnippet(['Box', 'Text'], [
      ...
      '  >',
      '    <Text>',
      '      O playground ja esta envelopado por ThemeProvider em main.tsx.',
      '    </Text>',
      '  </Box>',
      ');',
    ]),
  ...
  },
  {
    ...
    initialCode: jsxSnippet(['Box', 'Text', 'Button', 'useToast'], [
      ...
      '    <Text color="subtle">',
      '      Este exemplo usa o ToastProvider configurado na raiz do playground.',
      '    </Text>',
      '    <ToastDemo />',
      '  </Box>',
      ');',
